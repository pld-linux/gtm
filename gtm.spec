...
Summary(es.UTF-8):	Gestor de Transferencias GNOME
Summary(it.UTF-8):	Gestore di traferimenti del GNOME
Summary(pl.UTF-8):	Zarządca Transferu GNOME
Summary(pt.UTF-8):	Gestor de Transferências GNOME
Name:		gtm
Version:	0.4.11
Release:	3
License:	GPL
...
GTM pozwala użytkownikowi na przesyłanie wielu plików ze stron WWW.
Pliki mogą być przesyłane w wielu częściach przy czym każda cześć
przesyłana np. przy kolejnej sesji modemowej. GTM używa wget'a do
